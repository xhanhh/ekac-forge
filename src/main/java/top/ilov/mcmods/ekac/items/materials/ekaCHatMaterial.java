package top.ilov.mcmods.ekac.items.materials;
...
public enum ekaCHatMaterial implements IArmorMaterial {
    ...
    ekaCHatMaterial(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability, SoundEvent soundEvent, float toughness,
